...
class JlZfcgWinningSpider(scrapy.Spider):
    name = "jl_zfcg_winning"
    channel_id = '69311'
    
    # Singleton Config
    LOCK_KEY = "spider:lock:jl_zfcg_winning"
    LOCK_EXPIRE = 3600  # 1 hour safety timeout
    
    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(JlZfcgWinningSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def start_requests(self):
        # Note: If spider is closed in spider_opened, this might still run a bit or not at all depending on Scrapy version
        # But close_spider usually stops it.
    ...
    def parse_detail(self, response):
        ...
        loader.add_value('source_channel', 'zfcg')
        loader.add_value('stage', 2) # Winning Announcement
